...
INSERT INTO `gdoks_areas` VALUES (9,'Área 1','PA1',12),(10,'Área 2','PA2',12),(11,'Área 1 PRJB','AR1',13),(12,'Área 1 PD','PDA1',15),(13,'Área 2 PD','PDA2',15);
...
CREATE TABLE `gdoks_arquivos` (
  ...
  KEY `FKA_id_pda_x_pdas_idx` (`id_pda`),
  CONSTRAINT `FKA_id_pda_x_pdas` FOREIGN KEY (`id_pda`) REFERENCES `gdoks_pdas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `gdoks_arquivos` VALUES (1,'Caminho1','A.pdf',1,'2017-05-23 10:17:02',1,10),(2,'Caminho2','B.pdf',1,'2017-05-23 10:17:02',1,20),(3,'Caminho3','C.pdf',1,'2017-05-23 10:17:02',1,30),(4,'Caminho4','D.pdf',2,'2017-05-23 10:17:02',1,40),(5,'Caminho5','E.pdf',2,'2017-05-23 10:17:02',1,50),(6,'Caminho6','F.pdf',2,'2017-05-23 10:17:02',1,60),(7,'Caminho7','G.pdf',3,'2017-05-23 10:17:02',1,70),(8,'Caminho8','H.pdf',4,'2017-05-23 10:17:02',3,80),(9,'Caminho9','I.pdf',6,'2017-05-23 10:00:00',3,90),(10,'Caminho10','J.pdf',6,'2017-05-23 10:00:02',3,100),(17,'Caminho12','L.pdf',7,'2017-05-23 11:10:02',1,120),(18,'Caminho13','M.pdf',7,'2017-05-23 10:10:02',1,130);
...
INSERT INTO `gdoks_cargos` VALUES (6,'Engenheiro 1',500.00,1),(7,'Engenheiro 2',755.00,1),(9,'Técnico 1',350.00,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='documentos de abertura de operações';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `gdoks_disciplinas` VALUES (16,'Elétrica','ELE','',1),(17,'Hidráulica','HDR','',1),(18,'Civil','CIV','',1),(19,'Rodovias','ROD','',1);
...
INSERT INTO `gdoks_documentos` VALUES (25,'Documento 1','DOC1',2,21,'2017-05-21',NULL,NULL,NULL),(26,'Documento 2','DOC2',5,21,'2017-05-16',NULL,NULL,NULL),(27,'Documento 3','DOC3',2,20,'2017-05-10',NULL,NULL,NULL),(28,'Documento 4','DOC4',1,21,'2017-05-13',NULL,NULL,NULL),(29,'Documento 5','DOC5',3,20,'2017-05-01',NULL,NULL,NULL),(30,'Documento 6','DOC6',2,21,'2017-05-30',NULL,NULL,NULL),(31,'Documento 7','DOC7',4,23,'2017-05-31',NULL,NULL,NULL),(32,'Documento 8','DOC8',2,23,'2017-06-30',NULL,NULL,NULL),(33,'Documento 9','DOC9',2,21,'2017-07-31',NULL,NULL,NULL),(34,'Documento 10','DOC10',4,21,'2017-07-28',NULL,NULL,NULL),(35,'Documento 11','DOC11',5,23,'2017-05-16',NULL,NULL,NULL),(37,'Documento 16','DOC16',4,22,'2017-05-25',NULL,NULL,NULL),(38,'Doc Teste','DT1',4,20,'2017-05-28',NULL,NULL,NULL),(39,'Doc Teste 2','DT2',2,23,'2017-06-19',NULL,NULL,NULL);
...
INSERT INTO `gdoks_documentos_x_dependencias` VALUES (47,26,25),(48,26,30),(49,27,25),(56,33,27),(57,31,30),(58,34,25),(59,34,27),(60,34,30),(61,35,27),(63,28,26),(64,39,26),(65,39,25),(66,32,28),(67,32,26);
...
INSERT INTO `gdoks_especialistas` VALUES (35,1,16),(21,1,17),(22,8,17);
...
INSERT INTO `gdoks_hhemdocs` VALUES (11,25,6,1),(12,25,7,2),(14,33,6,1),(15,33,7,3),(16,31,7,3),(17,34,7,1),(18,39,6,2),(19,32,7,1),(20,32,9,3),(21,30,7,12),(22,30,9,15);
...
INSERT INTO `gdoks_pdas` VALUES (1,10,4,NULL,NULL),(2,15,5,NULL,NULL),(3,10,6,1,'2017-05-23 10:11:07'),(4,100,6,1,'2017-05-23 11:11:07'),(6,20,7,1,'2017-05-23 11:12:07'),(7,30,7,NULL,NULL);
...
INSERT INTO `gdoks_revisoes` VALUES (4,1,26,'2017-06-01',0,0,NULL),(5,1,27,'2017-06-02',100,0,NULL),(6,1,28,'2017-06-03',50,10,NULL),(7,2,28,'2017-05-22',60,40,'2017-05-23 22:00:10');
...
INSERT INTO `gdoks_subareas` VALUES (1,'Sub-área 1','SBA1',9),(2,'Sub-área 21','SBA21',10),(3,'Sub-área de Area11','SBA-X',11),(4,'Sub-área 3','SBA3',10),(5,'Sub-área 5','SBA5',9),(6,'Sub-área 1','PDA1.1',12);
...
INSERT INTO `gdoks_subdisciplinas` VALUES (20,'Tomadas Novas','ELE1','',16),(21,'Cabeamento','ELE2','',16),(22,'Tubulações','HDR1','',17),(23,'Válvulas','HDR2','',17),(24,'Conectores','ELE3','',16),(25,'Painéis','ELE4','',16),(26,'Cabou Criatividade','ELE5','',16);
...
INSERT INTO `gdoks_validadores` VALUES (23,1,18),(24,8,17),(27,1,16);
...
-- Dump completed on 2017-05-24 10:21:05
